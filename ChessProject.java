  ...
  private Boolean checkBlackOponent(int newX, int newY){
	...
	*/
    public void mouseReleased(MouseEvent e) {
        ...
        System.out.println("The xMovement is : "+yMovement);
...
if(pieceName.contains("Queen")){
  ...
  Boolean intheway = false; //rook
  Boolean inTheWay = false; //bish
  int distance = Math.abs(startX-landingY);
...
/*if(pieceName.equals("BlackQueen")){
  validMove = true;
      ...
      if(startY == 6){ //this is where the B pawn is making its first move
    ...
    else{//this is where the B pawn is making all subsequent moves.
  ...
  validMove = true;
			...
			if(startY == 1) /* if it starts at the orginal row*/
			{
				...
				{
					if((((e.getY()/75)-startY)==2)){  /* if it starts at the orginal row can move by two*/
						if((!piecePresent(e.getX(), (e.getY())))&&(!piecePresent(e.getX(), (e.getY()+75)))){
							validMove = true;
						}
						else{
